...
public class MainPageTest {
    ...
    @Test
    public void testArrowDescription() {
        initDriver();
        driver.get("https://qa-scooter.praktikum-services.ru/");
        MainPage mainPage = new MainPage(driver);
        String actualDescription = mainPage.getTextUnderArrow(arrowText);
        Assert.assertEquals(arrowDescription, actualDescription);
    }

    public void initDriver() {
        WebDriverManager.chromedriver().setup(); // Установка драйвера Chrome по умолчанию
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10)); // Подстройте времени ожидания по необходимости
    }
